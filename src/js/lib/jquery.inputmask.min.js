...
!(function(e) {
  ...
  function(e, t, n) {
    ...
    !(function(o) {
      (a = [n(2)]),
        void 0 !== (r = "function" == typeof (i = o) ? i.apply(t, a) : i) &&
          (e.exports = r);
    })(function(e) {
      return e;
    });
    ...
    !(function(o) {
      ...
      function s(t, n) {
        ...
        if ((e.isFunction(t.mask) && (t.mask = t.mask(t)), e.isArray(t.mask))) {
          if (t.mask.length > 1) {
            ...
            return (
              e.each(t.numericInput ? t.mask.reverse() : t.mask, function(
                n,
                a
              ) {
                o.length > 1 &&
      ...
      function l(e) {
        var t = n.createElement("input"),
          ...
          a = i in t;
        return (
          a || (t.setAttribute(i, "return;"), (a = "function" == typeof t[i])),
          (t = null),
          a
        );
      }
      function c(r, s, u) {
          ...
          do {
            !0 === e && h().validPositions[l]
              ? ((r = (o = h().validPositions[l]).match),
                (a = o.locator.slice()),
                s.push(!0 === n ? o.input : !1 === n ? r.nativeDef : F(l, r)))
              : ((r = (o = b(l, a, l - 1)).match),
                (a = o.locator.slice()),
                (!1 === u.jitMasking ||
                  l < c ||
            ...
            h().validPositions[o] !== i &&
              ((!0 !== a &&
                ((!h().validPositions[o].match.optionality &&
                  ...
                  !1 === u.canClearPosition(h(), o, v(i, !0), r, u))) ||
                delete h().validPositions[o]);
          for (g(!0), o = s + 1; o <= v(); ) {
            for (; h().validPositions[s] !== i; ) s++;
            if ((o < s && (o = s + 1), h().validPositions[o] === i && _(o)))
              o++;
            else {
              var p = b(o);
              !1 === c && l[s] && l[s].match.def === p.match.def
                ...
                : P(s, p.match.def)
                  ? !1 !== O(s, p.input || F(o), !0) &&
                    (delete h().validPositions[o], o++, (c = !0))
                  : _(o) || (o++, s--),
                s++;
            }
          }
            ...
            (!(
              ...
              (o.alternation === i ||
                ...
                (n.locator[o.alternation] !== i &&
                  M(n.locator[o.alternation].toString().split(","), s)))
            ) ||
              (!0 === t &&
        ...
        function b(e, t, n) {
          return h().validPositions[e] || y(S(e, t ? t.slice() : t, n));
        }
        function x(e) {
        ...
        function S(t, n, a) {
          function r(n, a, o, l) {
            function p(o, l, g) {
              ...
              function k(t, n, a) {
                var r, o;
                if (h().validPositions[t - 1] && a && h().tests[t])
                  for (
                ...
                return (
                  (h().tests[t] || h().validPositions[t]) &&
                    e.each(h().tests[t] || [h().validPositions[t]], function(
                      e,
                      t
                    ) {
              ...
              if (o.matches !== i) {
                if (o.isGroup && g !== o) {
                  ...
                  var y = o;
                  if ((o = r(o, a, l, g))) {
                    if (((s = f[f.length - 1].match), !v(s, y))) return !0;
                    (d = !0), (c = t);
                  }
                  ...
                  if (-1 === w || "string" == typeof w) {
                    var C,
                      ...
                      M = a.slice(),
                      O = [];
                    if ("string" == typeof w) O = w.split(",");
                    else for (C = 0; C < x.matches.length; C++) O.push(C);
                    for (var _ = 0; _ < O.length; _++) {
                      if (
                        ...
                        !0 !==
                          (o =
                            p(x.matches[C] || n.matches[C], [C].concat(l), g) ||
                            o) &&
                          o !== i &&
                          O[O.length - 1] < x.matches.length)
                      ) {
                        var D = e.inArray(o, n.matches) + 1;
                        n.matches.length > D &&
                          (o = p(
                            n.matches[D],
                            [D].concat(l.slice(1, l.length)),
                            g
                          )) &&
                          (O.push(D.toString()),
                      ...
                      for (var j = 0; j < b.length; j++) {
                        ...
                        for (var F = 0; F < P.length; F++) {
                          ...
                          if (
                            "string" != typeof w ||
                            -1 !==
                              e.inArray(T.locator[T.alternation].toString(), O)
                          ) {
                            if (
                              (function(e, t) {
                                return (
                              ...
                              (R = !0),
                                T.alternation === N.alternation &&
                                  ...
                                  (N.alternation = T.alternation)),
                                T.match.nativeDef === N.match.def &&
                                  ((T.locator[T.alternation] =
                                    N.locator[N.alternation]),
                                  P.splice(P.indexOf(N), 1, T));
                              break;
                            }
                            if (T.match.def === N.match.def) {
                              R = !1;
                              break;
                            }
                            if (
                    ...
                    "string" == typeof w &&
                      ...
                      (o = P.length > 0),
                      (a = M.slice());
                  } else o = p(x.matches[w] || n.matches[w], [w].concat(l), g);
                  if (o) return !0;
                } else if (
                  o.isQuantifier &&
                  ...
                  for (
                    var I = o, L = a.length > 0 ? a.shift() : 0;
                    L < (isNaN(I.quantifier.max) ? L + 1 : I.quantifier.max) &&
                    c <= t;
                    L++
                  ) {
                    var B = n.matches[e.inArray(I, n.matches) - 1];
                    if ((o = p(B, [L].concat(l), B))) {
                      if (
                        ((s = f[f.length - 1].match),
                        (s.optionalQuantifier = L > I.quantifier.min - 1),
                        v(s, B))
                      ) {
                        if (L > I.quantifier.min - 1) {
                          (d = !0), (c = t);
                          break;
                        }
                        return !0;
          ...
          if (t > -1) {
            if (n === i) {
              for (
                var g, v = t - 1;
                (g = h().validPositions[v] || h().tests[v]) === i && v > -1;
              ...
              g !== i &&
                ...
                ((p = (function(t) {
                  ...
                  return (
                    ...
                    t.length > 0 &&
                      (t[0].alternation === i
                        ? 0 === (n = y(t.slice()).locator.slice()).length &&
                          (n = t[0].locator.slice())
                            ...
                            if ("" !== t.def)
                              if (0 === n.length) n = t.locator.slice();
                                ...
                                for (var i = 0; i < n.length; i++)
                                  t.locator[i] &&
                                    -1 ===
                                      n[i].toString().indexOf(t.locator[i]) &&
                                    (n[i] += "," + t.locator[i]);
                          })),
                    n
                  );
        ...
        function w(e) {
          return (
            (h().buffer !== i && !0 !== e) || (h().buffer = m(!0, v(), !0)),
            h().buffer
          );
        }
        function C(e, t, n) {
        ...
        function E(t, n, i) {
          switch (u.casing || n.casing) {
            ...
            case "title":
              ...
              t =
                0 === i ||
                (r && r.input === String.fromCharCode(a.keyCode.SPACE))
                  ? t.toUpperCase()
                  : t.toLowerCase();
              break;
            default:
              if (e.isFunction(u.casing)) {
                ...
                o.push(h().validPositions), (t = u.casing.apply(this, o));
              }
          }
          return t;
        }
        ...
        function O(t, n, r, o, s, l) {
          ...
          function p(n, a, r) {
            ...
            return (
              e.each(S(n), function(l, p) {
                for (
                  var d = p.match, m = a ? 1 : 0, y = "", b = d.cardinality;
                  b > m;
                  b--
                )
                  y += T(n - (b - 1));
                if (
                  ...
                  !1 !==
                    (s =
                      null != d.fn
                        ? d.fn.test(y, h(), n, r, u, c(t))
                        : (a === d.def || a === u.skipOptionalPartCharacter) &&
                          "" !== d.def && { c: F(n, d, !0) || d.def, pos: n }))
                ) {
                  var x = s.c !== i ? s.c : a;
                  x =
                    x === u.skipOptionalPartCharacter && null === d.fn
                      ? F(n, d, !0) || d.def
                      : x;
                  var P = n,
                    S = w();
                  if (
                    ...
                    if (
                      (C(!0 === A ? A : A.start, A.end, S),
                      s.pos === i && s.c === i)
                    )
                      return (s.pos = v()), !1;
                    if ((P = s.pos !== i ? s.pos : n) !== n)
                      return (s = e.extend(s, O(P, x, !0, o))), !1;
                  } else if (
                    !0 !== s &&
                    s.pos !== i &&
                    s.pos !== n &&
                    ((P = s.pos), C(n, P, w().slice()), P !== n)
                  )
                    return (s = e.extend(s, O(P, x, !0))), !1;
                  return (
                    (!0 === s || s.pos !== i || s.c !== i) &&
                    (l > 0 && g(!0),
                    f(P, e.extend({}, p, { input: E(x, d, P) }), o, c(t)) ||
                      (s = !1),
                    !1)
                  );
                }
              ...
              for (o = c = t; o <= l; o++) {
                ...
                if (y !== i)
                  for (
                    ...
                    if (
                      (b++, !1 === m && s[b] && s[b].match.def === y.match.def)
                    )
                      ...
                      (p = !1 !== x),
                        (c = x.caret || x.insert ? v() : b),
                        (m = !0);
                    } else if (
                      !(p = !0 === y.generatedInput) &&
                      b >= h().maskLength - 1
                    )
                      break;
              ...
              h().validPositions[n] === i &&
                ...
                ("" ===
                  (r = S(n, b(n - 1).locator, n - 1).slice())[r.length - 1]
                    .match.def && r.pop(),
                (a = y(r)) &&
                  (a.match.def === u.radixPointDefinitionSymbol ||
                    !_(n, !0) ||
                    (e.inArray(u.radixPoint, w()) < n &&
                      a.match.fn &&
                      a.match.fn.test(F(n), h(), n, !1, u))) &&
                  !1 !==
                    (x = p(
                      n,
                      F(n, a.match, !0) ||
          ...
          r = !0 === r;
          var m = t;
          t.begin !== i && (m = J && !c(t) ? t.end : t.begin);
          var x = !0,
            A = e.extend(!0, {}, h().validPositions);
          if (
            (e.isFunction(u.preValidation) &&
              !r &&
              !0 !== o &&
              !0 !== l &&
              (x = u.preValidation(w(), m, n, c(t), u)),
            !0 === x)
          ) {
            if (
              (d(m),
              c(t) && (H(i, a.keyCode.DELETE, t, !0, !0), (m = h().p)),
              m < h().maskLength &&
                (Q === i || m < Q) &&
                ((x = p(m, n, r)), (!r || !0 === o) && !1 === x && !0 !== l))
            ) {
              var j = h().validPositions[m];
              if (
                !j ||
                null !== j.match.fn ||
                (j.match.def !== n && n !== u.skipOptionalPartCharacter)
              ) {
                if (
                  (u.insertMode || h().validPositions[D(m)] === i) &&
                  !_(m, !0)
                )
                  for (var R = m + 1, N = D(m); R <= N; R++)
                    if (!1 !== (x = p(R, n, r))) {
                      !(function(t, n) {
                        var a = h().validPositions[n];
                        if (a)
                          for (
                            var r = a.locator, o = r.length, s = t;
                            s < n;
                            s++
                          )
                            if (h().validPositions[s] === i && !_(s, !0)) {
                              ...
                              "" === l[l.length - 1].match.def && l.pop(),
                                ...
                                ((c = e.extend({}, c, {
                                  input: F(s, c.match, !0) || c.match.def
                                })).generatedInput = !0),
                                f(s, c, !0),
                                (h().validPositions[n] = i),
                                p(n, a.input, !0);
            ...
            !1 === x &&
              ...
              (x = (function(t, n, a) {
                ...
                if (s !== i) {
                  m = parseInt(r);
                  var x =
                    c.locator[c.alternation || s] !== i
                      ? c.locator[c.alternation || s]
                      : d[0];
                  x.length > 0 && (x = x.split(",")[0]);
                  var P = h().validPositions[m],
                    A = h().validPositions[m - 1];
                  e.each(S(m, A ? A.locator : i, m - 1), function(r, l) {
                    ...
                    for (var c = 0; c < d.length; c++) {
                      ...
                      if (
                        x < d[c] &&
                        (l.na === i ||
                          -1 === e.inArray(d[c], l.na.split(",")) ||
                          -1 === e.inArray(x.toString(), d))
                      ) {
                        h().validPositions[m] = e.extend(!0, {}, l);
                        var C = h().validPositions[m].locator;
                        for (
                          h().validPositions[m].locator[s] = parseInt(d[c]),
                            null == l.match.fn
                              ? (P.input !== l.match.def &&
                                  ((w = !0),
                        ...
                        for (
                          w && b[0] === l.match.def && b.shift(), g(!0), y = !0;
                          b.length > 0;

                        ) {
                          var E = b.shift();
                          if (
                            E !== u.skipOptionalPartCharacter &&
                            !(y = O(v(i, !0) + 1, E, !1, o, !0))
                          )
                            break;
                        }
                        if (y) {
                          h().validPositions[m].locator = C;
                          var M = v(t) + 1;
                          for (p = m + 1; p < v() + 1; p++)
                            ((f = h().validPositions[p]) === i ||
                              null == f.match.fn) &&
                              p < t + (A - S) &&
                              A++;
                        ...
                        if (y) return !1;
                        g(), (h().validPositions = e.extend(!0, {}, k));
                      }
                    }
                  });
                }
          ...
          if (
            ...
            var I = u.postValidation(w(!0), x, u);
            if (I !== i) {
              if (I.refreshFromBuffer && I.buffer) {
                var L = I.refreshFromBuffer;
                C(!0 === L ? L : L.start, L.end, I.buffer);
              }
              x = !0 === I ? x : I;
            }
          }
          return (
            x && x.pos === i && (x.pos = m),
            (!1 !== x && !0 !== l) ||
              (g(!0), (h().validPositions = e.extend(!0, {}, A))),
            x
          );
        }
        function _(e, t) {
        ...
        function D(e, t) {
          ...
          for (
            ...
            ++i < n &&
            ((!0 === t && (!0 !== x(i).match.newBlockMarker || !_(i))) ||
              (!0 !== t && !_(i)));
        ...
        function j(e, t) {
          ...
          for (
            ;
            --i > 0 &&
            ((!0 === t && !0 !== x(i).match.newBlockMarker) ||
              (!0 !== t &&
                !_(i) &&
                ((n = S(i)).length < 2 ||
        ...
        function T(e) {
          return h().validPositions[e] === i
            ? F(e)
            : h().validPositions[e].input;
        }
        function R(t, n, a, r, o) {
          if (r && e.isFunction(u.onBeforeWrite)) {
            var s = u.onBeforeWrite.call($, r, n, a, u);
            if (s) {
              if (s.refreshFromBuffer) {
                var l = s.refreshFromBuffer;
                C(!0 === l ? l : l.start, l.end, s.buffer || n), (n = w(!0));
              }
              ...
              if (o.length > 1 + ("" === o[o.length - 1].match.def ? 1 : 0))
                for (var l = 0; l < o.length; l++)
                  if (
                    ...
                    (null === o[l].match.fn ||
                      r === i ||
                      !1 !== o[l].match.fn.test(r.match.def, h(), t, !0, u)) &&
                    (s.push(o[l]),
        ...
        function N(t, r, o, s, l) {
          ...
          var p = s.slice(),
            ...
            d = -1,
            m = i;
          if ((g(), o || !0 === u.autoUnmask)) d = D(d);
          else {
            var k = A()
                .slice(0, D(-1))
                .join(""),
              y = p.join("").match(new RegExp("^" + a.escapeRegex(k), "g"));
            y && y.length > 0 && (p.splice(0, y.length * k.length), (d = D(d)));
          }
          if (
            (-1 === d ? ((h().p = D(d)), (d = 0)) : (h().p = d),
            e.each(p, function(n, a) {
              if (a !== i)
                if (
                  h().validPositions[n] === i &&
                  p[n] === F(n) &&
                  ...
                  var s = v(i, !0),
                    ...
                    k = b(s + 1, l ? l.locator.slice() : i, s);
                  if (!c(d, f) || o || u.autoUnmask) {
                    var y = o
                      ? n
                      : null == k.match.fn &&
                        k.match.optionality &&
                        ...
                        ? s + 1
                        : h().p;
                    (m = ae.keypressEvent.call(t, r, !0, !1, o, y)),
                      (d = y + 1),
                      (f = "");
                  } else m = ae.keypressEvent.call(t, r, !0, !1, !0, s + 1);
                  if (!1 !== m && !o && e.isFunction(u.onBeforeWrite)) {
                    var x = m;
                    if (
                      ((m = u.onBeforeWrite.call(
                        $,
                        r,
                        w(),
                        m.forwardPosition,
                      ...
                      C(!0 === P ? P : P.start, P.end, m.buffer),
                        g(!0),
                        m.caret &&
            ...
            n.activeElement === t &&
              m &&
              (P = u.numericInput ? j(m.forwardPosition) : m.forwardPosition),
              R(
                t,
                w(),
                P,
        ...
        function L(e, a, r, o) {
          ...
          if (
            ...
            if (
              ...
              !1 === u.insertMode && a === r && r++,
              (e.inputmask.caretPos = { begin: a, end: r }),
              e.setSelectionRange)
            )
        ...
        function B(t) {
          ...
          for (
            ...
            (((a = l[n]).match.optionality ||
              ...
              (p &&
                ((p !== l[n].locator[c.alternation] && null != a.match.fn) ||
                  (null === a.match.fn &&
        ...
        function G(e) {
          for (
            var t, n = B(), a = e.length, r = h().validPositions[v()];
            n < a &&
            !_(n, !0) &&
            (t = r !== i ? b(n, r.locator.slice(""), r) : x(n)) &&
            !0 !== t.match.optionality &&
            ((!0 !== t.match.optionalQuantifier &&
              !0 !== t.match.newBlockMarker) ||
              (n + 1 === a &&
                "" ===
                  (r !== i ? b(n + 1, r.locator.slice(""), r) : x(n + 1)).match
                    .def));
          ...
          for (
            ...
            t &&
            t.match.optionality &&
            t.input === u.skipOptionalPartCharacter;
        ...
        function H(t, n, r, o, s) {
          ...
          n === a.keyCode.BACKSPACE &&
          (r.end - r.begin < 1 || !1 === u.insertMode)
            ? ((r.begin = j(r.begin)),
              h().validPositions[r.begin] !== i &&
                h().validPositions[r.begin].input === u.groupSeparator &&
                r.begin--)
            : n === a.keyCode.DELETE &&
              r.begin === r.end &&
              ((r.end =
                ...
                h().validPositions[r.end].input !== u.radixPoint
                  ? r.end + 1
                  : D(r.end) + 1),
              h().validPositions[r.begin] !== i &&
                h().validPositions[r.begin].input === u.groupSeparator &&
        ...
        function K(e, t, a) {
          function r() {
            f || (null !== s.fn && l.input !== i)
              ? f &&
                ((null !== s.fn && l.input !== i) || "" === s.def) &&
                ((f = !1), (p += "</span>"))
          ...
          if (Z !== i) {
            ...
            (k.innerHTML = p), e.inputmask.positionColorMask(e, k);
          }
        }
                ...
                if (n.inputmask === i && "FORM" !== this.nodeName) {
                  ...
                  if (
                      ...
                      (n.readOnly &&
                        !(
                          ("keydown" === t.type &&
                            t.ctrlKey &&
                            67 === t.keyCode) ||
                          (!1 === u.tabThrough && t.keyCode === a.keyCode.TAB)
                        ))
                    )
                  ) {
                    switch (t.type) {
                      case "input":
                        if (!0 === Y) return (Y = !1), t.preventDefault();
                        p && (ne = !0);
                        break;
                      case "keydown":
                        (X = !1), (Y = !1);
                    ...
                    return (
                      ...
                      !1 === l && (t.preventDefault(), t.stopPropagation()),
                      l
                    );
                  }
                  t.preventDefault();
          ...
          ae = {
            keydownEvent: function(t) {
              ...
              if (
                ...
                r === a.keyCode.DELETE ||
                (d && r === a.keyCode.BACKSPACE_SAFARI) ||
                ...
                t.preventDefault(),
                  ...
                  n.inputmask._valueGet() === A().join("")
                    ? i.trigger("cleared")
                    : !0 === U(w()) && i.trigger("complete");
              else if (r === a.keyCode.END || r === a.keyCode.PAGE_DOWN) {
                t.preventDefault();
                var s = D(v());
                u.insertMode || s !== h().maskLength || t.shiftKey || s--,
                  L(n, t.shiftKey ? o.begin : s, s, !0);
              } else
                (r === a.keyCode.HOME && !t.shiftKey) || r === a.keyCode.PAGE_UP
                  ? (t.preventDefault(), L(n, 0, t.shiftKey ? o.begin : 0, !0))
                  : ((u.undoOnEscape && r === a.keyCode.ESCAPE) ||
                      (90 === r && t.ctrlKey)) &&
                    !0 !== t.altKey
                    ? (N(n, !0, !1, z.split("")), i.trigger("click"))
                    : r !== a.keyCode.INSERT || t.shiftKey || t.ctrlKey
                      ? !0 === u.tabThrough && r === a.keyCode.TAB
                        ? (!0 === t.shiftKey
                            ? (null === x(o.begin).match.fn &&
                                (o.begin = D(o.begin)),
                              (o.end = j(o.begin, !0)),
                              (o.begin = j(o.end, !0)))
                            : ((o.begin = D(o.begin, !0)),
                          ...
                          o.begin < h().maskLength &&
                            (t.preventDefault(), L(n, o.begin, o.end)))
                        : t.shiftKey ||
                          (!1 === u.insertMode &&
                            (r === a.keyCode.RIGHT
                              ? setTimeout(function() {
                              ...
                              : r === a.keyCode.LEFT &&
                                setTimeout(function() {
                                  var e = L(n);
                                  L(n, J ? e.begin + 1 : e.begin - 1);
                                }, 0)))
                      : ((u.insertMode = !u.insertMode),
                        L(
                          n,
                          u.insertMode || o.begin !== h().maskLength
                            ? o.begin
                            : o.begin - 1
                        ));
              u.onKeyDown.call(this, t, w(), L(n).begin, u),
                (ee = -1 !== e.inArray(r, u.ignorables));
            },
            keypressEvent: function(t, n, r, o, s) {
              ...
              if (p) {
                ...
                if (
                  (!1 !== v &&
                    (g(!0),
                    (f = v.caret !== i ? v.caret : n ? v.pos + 1 : D(v.pos)),
                    (h().p = f)),
                  !1 !== r &&
                    (setTimeout(function() {
                  ...
                  R(
                    l,
                    k,
                    u.numericInput && v.caret === i ? j(f) : f,
                    t,
                    !0 !== n
                  ),
                    !0 !== n &&
            ...
            pasteEvent: function(n) {
              ...
              if (
                (c === (J ? A().reverse() : A()).slice(0, l.begin).join("") &&
                  (c = ""),
                p === (J ? A().reverse() : A()).slice(l.end).join("") &&
                  (p = ""),
                J && ((i = c), (c = p), (p = i)),
                t.clipboardData && t.clipboardData.getData)
              )
                s = c + t.clipboardData.getData("Text") + p;
              else {
                if (!r.clipboardData || !r.clipboardData.getData) return !0;
                s = c + r.clipboardData.getData("text/plain") + p;
              }
              var f = s;
              if (e.isFunction(u.onBeforePaste)) {
                if (!1 === (f = u.onBeforePaste.call($, s, u)))
              ...
              return (
                N(
                  ...
                  !1,
                  !1,
                  J ? f.split("").reverse() : f.toString().split("")
                ),
                R(a, w(), D(v()), n, z !== w().join("")),
                !0 === U(w()) && o.trigger("complete"),
                n.preventDefault()
              );
            },
                ...
                if (
                  ((i = (function(e, t, n) {
                    return (
                      "." === t.charAt(n.begin - 1) &&
                        "" !== u.radixPoint &&
                        (((t = t.split(""))[n.begin - 1] = u.radixPoint.charAt(
                          0
                        )),
                        (t = t.join(""))),
                      t
                  ...
                  r.begin > i.length && (L(n, i.length), (r = L(n))),
                  w().join("") !== i)
                ) {
                  var o = w().join(""),
                  ...
                  if (l !== p) {
                    for (
                      var v = (g = l.length >= p.length) ? l.length : p.length,
                        k = 0;
                      l.charAt(k) === p.charAt(k) && k < v;
                      k++
                    );
                    g && (0 === s && (m.begin = k), (h += l.slice(k, m.end)));
                  }
                  if (
                    (c !== d &&
                      (c.length > d.length
                        ? (h += c.slice(0, 1))
                        : c.length < d.length &&
                          ((m.end += d.length - c.length),
                          g ||
                            "" === u.radixPoint ||
                            "" !== c ||
                            l.charAt(m.begin + s - 1) !== u.radixPoint ||
                            (m.begin--, (h = u.radixPoint)))),
                    R(n, w(), { begin: m.begin + s, end: m.end + s }),
                    h.length > 0)
                  )
                    ...
                    (y.keyCode = a.keyCode.DELETE),
                      ae.keydownEvent.call(n, y),
                      !1 === u.insertMode && L(n, L(n).begin - 1);
                  }
                  t.preventDefault();
                }
              }
            ...
            setValueEvent: function(t) {
              ...
              e.isFunction(u.onBeforeMask) &&
                (i = u.onBeforeMask.call($, i, u) || i),
                (i = i.split("")),
                N(n, !0, !1, J ? i.reverse() : i),
                (z = w().join("")),
            ...
            focusEvent: function(e) {
              ...
              u.showMaskOnFocus &&
                ...
                (t.inputmask._valueGet() !== w().join("")
                  ? R(t, w(), D(v()))
                  : !1 === te && L(t, D(v()))),
                !0 === u.positionCaretOnTab &&
                  !1 === te &&
                  "" !== n &&
                  (R(t, w(), L(t)), ae.clickEvent.apply(t, [e, !0])),
                (z = w().join(""));
            },
            mouseleaveEvent: function(e) {
              var t = this;
              if (
                ((te = !1), u.clearMaskOnLostFocus && n.activeElement !== t)
              ) {
                var i = w().slice(),
                  a = t.inputmask._valueGet();
                a !== t.getAttribute("placeholder") &&
                  "" !== a &&
                  (-1 === v() && a === A().join("") ? (i = []) : G(i), R(t, i));
              }
            },
            clickEvent: function(t, a) {
              function r(t) {
                if ("" !== u.radixPoint) {
                  ...
                  if (n[t] === i || n[t].input === F(t)) {
                    if (t < D(-1)) return !0;
                    var a = e.inArray(u.radixPoint, w());
                    if (-1 !== a) {
                      for (var r in n)
              ...
              setTimeout(function() {
                if (n.activeElement === o) {
                  var e = L(o);
                  if (
                    (a && (J ? (e.end = e.begin) : (e.begin = e.end)),
                    e.begin === e.end)
                  )
                    switch (u.positionCaretOnClick) {
                      ...
                      default:
                        var s = e.begin,
                          l = v(s, !0),
                          c = D(l);
                        if (s < c) L(o, _(s, !0) || _(s - 1, !0) ? s : D(s));
                        else {
            ...
            cutEvent: function(i) {
              var r = this,
                ...
                u = J ? w().slice(s.end, s.begin) : w().slice(s.begin, s.end);
              c.setData("text", J ? u.reverse().join("") : u.join("")),
                n.execCommand && n.execCommand("copy"),
                H(r, a.keyCode.DELETE, s),
                R(r, w(), h().p, i, z !== w().join("")),
                r.inputmask._valueGet() === A().join("") &&
                  o.trigger("cleared");
            },
              ...
              if (a.inputmask) {
                ...
                "" !== r &&
                  ...
                  !1 === U(o) &&
                    ...
                    u.clearIncomplete &&
                      (g(), (o = u.clearMaskOnLostFocus ? [] : A().slice()))),
                  R(a, o, i, t)),
                  z !== w().join("") && ((z = o.join("")), n.trigger("change"));
              }
            },
            ...
            submitEvent: function(e) {
              z !== w().join("") && W.trigger("change"),
                u.clearMaskOnLostFocus &&
                  -1 === v() &&
                  q.inputmask._valueGet &&
                  q.inputmask._valueGet() === A().join("") &&
          ...
          switch (r.action) {
            ...
            case "unmaskedvalue":
              return (
                (q !== i && r.value === i) ||
                  ((re = r.value),
                  (re = (e.isFunction(u.onBeforeMask)
                    ? u.onBeforeMask.call($, re, u) || re
                    : re
                  ).split("")),
                  N(i, !1, !1, J ? re.reverse() : re),
                  e.isFunction(u.onBeforeWrite) &&
                    u.onBeforeWrite.call($, i, w(), 0, u)),
                I(q)
              );
            case "mask":
              !(function(t) {
                ...
                if (
                  ...
                  ((q = t),
                  (W = e(q)),
                  -1 === (Q = q !== i ? q.maxLength : i) && (Q = i),
                  !0 === u.colorMask && V(q),
                  p &&
                    (q.hasOwnProperty("inputmode") &&
                      ((q.inputmode = u.inputmode),
                      q.setAttribute("inputmode", u.inputmode)),
                    "true" === u.disablePredictiveText &&
                      (!0 !== u.colorMask && V(q), (q.type = "password"))),
                  !0 === a &&
                    (ie.on(q, "submit", ae.submitEvent),
                    ie.on(q, "reset", ae.resetEvent),
                    ie.on(q, "mouseenter", ae.mouseenterEvent),
                    ie.on(q, "blur", ae.blurEvent),
                    ie.on(q, "focus", ae.focusEvent),
                    ie.on(q, "mouseleave", ae.mouseleaveEvent),
                    !0 !== u.colorMask && ie.on(q, "click", ae.clickEvent),
                    ie.on(q, "dblclick", ae.dblclickEvent),
                    ie.on(q, "paste", ae.pasteEvent),
                    ie.on(q, "dragdrop", ae.pasteEvent),
                    ie.on(q, "drop", ae.pasteEvent),
                    ie.on(q, "cut", ae.cutEvent),
                    ie.on(q, "complete", u.oncomplete),
                    ie.on(q, "incomplete", u.onincomplete),
                    ie.on(q, "cleared", u.oncleared),
                    p || !0 === u.inputEventOnly
                      ? q.removeAttribute("maxLength")
                      : (ie.on(q, "keydown", ae.keydownEvent),
                        ie.on(q, "keypress", ae.keypressEvent)),
                    ie.on(q, "compositionstart", e.noop),
                    ie.on(q, "compositionupdate", e.noop),
                    ie.on(q, "compositionend", e.noop),
                    ie.on(q, "keyup", e.noop),
                    ie.on(q, "input", ae.inputFallBackEvent),
                    ie.on(q, "beforeinput", e.noop)),
                  ie.on(q, "setvalue", ae.setValueEvent),
                  (z = A().join("")),
                  "" !== q.inputmask._valueGet(!0) ||
                    !1 === u.clearMaskOnLostFocus ||
                    n.activeElement === q)
                ) {
                  var r = e.isFunction(u.onBeforeMask)
                    ? u.onBeforeMask.call($, q.inputmask._valueGet(!0), u) ||
                      q.inputmask._valueGet(!0)
                    : q.inputmask._valueGet(!0);
                  "" !== r &&
                    N(q, !0, !1, J ? r.split("").reverse() : r.split(""));
                  var s = w().slice();
                  (z = s.join("")),
                    !1 === U(s) && u.clearIncomplete && g(),
                    u.clearMaskOnLostFocus &&
                      n.activeElement !== q &&
                      (-1 === v() ? (s = []) : G(s)),
                    R(q, s),
                    n.activeElement === q && L(q, D(v()));
                }
              })(q);
              break;
            case "format":
              return (
                (re = (e.isFunction(u.onBeforeMask)
                  ? u.onBeforeMask.call($, r.value, u) || r.value
                  : r.value
                ).split("")),
                N(i, !0, !1, J ? re.reverse() : re),
                r.metadata
                  ? {
                      value: J
                        ? w()
                            ...
                            .join("")
                        : w().join(""),
                      metadata: c.call(this, { action: "getmetadata" }, s, u)
                    }
                  : J
                    ? w()
                        .slice()
            ...
            case "isValid":
              r.value
                ? ((re = r.value.split("")),
                  N(i, !0, !0, J ? re.reverse() : re))
                : (r.value = w().join(""));
              for (
                var oe = w(), se = B(), le = oe.length - 1;
                le > se && !_(le);
                le--
              );
              return (
                oe.splice(se, le + 1 - se), U(oe) && r.value === w().join("")
              );
            case "getemptymask":
              return A().join("");
            case "remove":
              if (q && q.inputmask) {
                (W = e(q)),
                  q.inputmask._valueSet(
                    u.autoUnmask ? I(q) : q.inputmask._valueGet(!0)
                  ),
                  ie.off(q),
                  q.inputmask.colorMask &&
                    ((Z = q.inputmask.colorMask).removeChild(q),
          ...
          mask: function(o) {
            function l(n, a, o, s) {
              if (!0 === a.importDataAttributes) {
                ...
                f("alias", u), o.alias && r(o.alias, o, a);
                for (l in a) {
                  if (c) {
                    u = i;
                    for (p in c)
            ...
            return (
              ...
              e.each(o, function(t, n) {
                ...
                l(n, r, e.extend(!0, {}, u.userOptions), u.dataAttribute);
                    ...
                    if (((d = P.pop()), (d.openGroup = !1), d !== i))
                      if (P.length > 0) {
                        if (
                          ...
                          h = P.pop();
                          for (var A = 0; A < h.matches.length; A++)
                            (h.matches[A].isGroup = !1),
                              (h.matches[A].alternatorGroup = !1);
                          P.length > 0
                            ? (m = P[P.length - 1]).matches.push(h)
                            : x.matches.push(h);
                        }
                  ...
                  case r.quantifiermarker.start:
                    var w = new o(!1, !1, !0),
                      ...
                      M =
                        1 === C.length
                          ? E
                          : isNaN(C[1]) ? C[1] : parseInt(C[1]);
                    if (
                      (("*" !== M && "+" !== M) || (E = "*" === M ? 0 : 1),
                      (w.quantifier = { min: E, max: M }),
                      P.length > 0)
                    ) {
                      var O = P[P.length - 1].matches;
                      (p = O.pop()).isGroup ||
  ...
  function(e, t, n) {
    ...
    n(4), n(9), n(12), n(13), n(14);
    var a = i(n(1)),
      r = i(n(0)),
      o = i(n(2));
    r.default === o.default && n(15), (window.Inputmask = a.default);
  },
  function(e, t, n) {
    var i = n(5);
  ...
  function(e, t, n) {
    ...
    function r(e, t) {
      ...
      if ("top" === e.insertAt)
        i
          ? i.nextSibling ? n.insertBefore(t, i.nextSibling) : n.appendChild(t)
  ...
  function(e, t, n) {
    ...
    !(function(o) {
      ...
      function i(e) {
        return 29 === new Date(e, 2, 0).getDate();
      }
      function a(e, t) {
        var n = !0;
        return (
          t.min &&
            ...
            (n = n && t.min.date.getTime() <= e.getTime()),
          t.max &&
            t.max.date.getTime() === t.max.date.getTime() &&
            (n = n && t.max.date.getTime() >= e.getTime()),
          n
        );
      }
      function r(t, i) {
        for (var a, r = ""; (a = n(i).exec(t)); )
          r += s[a[0]]
            ? "(" +
              (e.isFunction(s[a[0]]) ? s[a[0]](i.min, i.max) : s[a[0]]) +
              ")"
            : a[0];
        return r;
      }
      function o(e, t, i) {
        function a(e) {
          ...
          return (
            i.min && i.min.year && i.max && i.max.year
              ? ((t = t.replace(/[^0-9]/g, "")),
                (t =
                  e.charAt(0) === i.max.year.charAt(0)
                    ? e.replace(/[^0-9]/g, "0")
                    : t + i.min.year.substr(t.length)))
              : (t = t.replace(/[^0-9]/g, "0")),
            t
          );
        }
        ...
        if ("string" == typeof c) {
          for (; (o = n(i).exec(t)); )
            if ("d" === o[0].charAt(0)) r = "day";
            else if ("m" === o[0].charAt(0)) r = "month";
            else if ("y" === o[0].charAt(0)) r = "year";
            else if ("h" === o[0].charAt(0).toLowerCase()) r = "hour";
            else if ("M" === o[0].charAt(0)) r = "minutes";
            else if ("s" === o[0].charAt(0)) r = "seconds";
            else if (s.hasOwnProperty(o[0])) r = "unmatched";
            else {
              var u = c.split(o[0])[0];
              "year" === r
                ? ((l[r] = a(u)), (l["raw" + r] = u))
                : (l[r] = i.min && u.match(/[^0-9]/) ? i.min[r] : u),
                (c = c.slice((u + o[0]).length)),
                (r = void 0);
            }
          return (
            void 0 !== r &&
          ...
          datetime: {
            mask: function(e) {
              return (
                ...
                (e.displayFormat =
                  l[e.displayFormat] || e.displayFormat || e.inputFormat),
                (e.outputFormat =
                  l[e.outputFormat] || e.outputFormat || e.inputFormat),
                (e.placeholder =
            ...
            postValidation: function(e, t, n) {
              var r = o(e.join(""), n.inputFormat, n),
                s = t;
              return (
                s &&
                  isFinite(r.rawyear) &&
            ...
            onKeyDown: function(i, a, r, o) {
              ...
              if (i.ctrlKey && i.keyCode === t.keyCode.RIGHT) {
                for (
                  var l, c = new Date(), u = "";
                  (l = n(o).exec(o.inputFormat));

                )
                  "d" === l[0].charAt(0)
                    ? (u += c.getDate().toString())
                    : "m" === l[0].charAt(0)
                      ? (u += (c.getMonth() + 1).toString())
                      : "yyyy" === l[0]
                        ? (u += c.getFullYear().toString())
                        : "yy" === l[0] && (u += c.getYear().toString());
          ...
          numeric: {
            ...
            preValidation: function(t, i, a, r, o) {
              ...
              if (
                ...
                if (-1 !== s)
                  return !0 === o.numericInput ? i === s : { caret: s + 1 };
              }
              return !0;
            },
            postValidation: function(i, a, r) {
                  ...
                  for (var m = 1; m <= r.digits; m++)
                    ...
                    (p[f + m] !== n && p[f + m] !== r.placeholder.charAt(0))
                      ? -1 !== d &&
                        c[d + m] !== n &&
                        (p[f + m] = p[f + m] || c[d + m])
                      : (p[f + m] = a.placeholder || r.placeholder.charAt(0));
                }
                if (
                  !0 !== r.autoGroup ||
                  "" === r.groupSeparator ||
                  (u === r.radixPoint && a.pos === n && !a.dopost)
                )
                  p = p.join("");
                else {
                  var h =
                    p[p.length - 1] === r.radixPoint && a.c === r.radixPoint;
                  (p = t(
                    (function(e, t) {
                      var n = "";
                      if (
              ...
              var v = {
                caret:
                  u === n || a.pos !== n ? l + (r.numericInput ? -1 : 1) : l,
                buffer: p,
              ...
              return (
                ...
                i.unmaskAsNumber
                  ? ("" !== i.radixPoint &&
                    ...
                    (a = a.replace(
                      new RegExp(t.escapeRegex(i.negationSymbol.back) + "$"),
                      ""
                    )),
                    Number(a))
                  : a
            ...
            isComplete: function(e, n) {
              ...
              return (
                (a = a.replace(n.suffix, "")),
                (a = a.replace(
                  new RegExp(t.escapeRegex(n.groupSeparator), "g"),
                  ""
                )),
                "," === n.radixPoint &&
                  (a = a.replace(t.escapeRegex(n.radixPoint), ".")),
                isFinite(a)
              );
            },
    ...
    !(function(o) {
      ...
      function n(e, t) {
        ...
        return 0 === r.indexOf(a)
          ? -1
          : 0 === a.indexOf(r) ? 1 : n.localeCompare(i);
      }
